...
class DogDataset:
    ...
    Dog Dataset.
    """
    def __init__(self, batch_size=4, dataset_path='data/images/dogs'):
    ...
    def get_transforms(self):
        ...
        transform_list = [
            ...
            torchvision.transforms.Normalize(self.x_mean,self.x_std)
        ]
...
class DogCatDataset:
    ...
    def get_transforms(self):
        # TODO (part d): fill in the data transforms
        transform_list = [
...
if __name__ == '__main__':
    dataset = DogDataset()
    print('Mean: ',dataset.x_mean, 'Std: ',dataset.x_std)
