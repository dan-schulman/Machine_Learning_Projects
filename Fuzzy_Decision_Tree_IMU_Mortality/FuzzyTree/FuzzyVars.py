from numpy import mean, log, iterable,sqrt
...
def ClassSimilarity(C,P,name):
    ...
    results = {}
    for k in P.keys():
        print(str(name)+str(k))
        results[str(name)+str(k)] = w[k]*FuzzyEvidence(C, P[k]).similarity()
